...
public class user_info extends JFrame implements ActionListener {
	...
	public user_info(String username) {		/* engine db_engine */
		super("User Info - " + username);
		...
		reload_button.setLocation(save_button.getLocation().x-10-reload_button.getWidth(), save_button.getLocation().y);
	...
	public static void main(String args[]) {
		user_info test = new user_info("test user");
	}
}

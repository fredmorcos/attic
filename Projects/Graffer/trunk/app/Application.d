...
public:
	this() {
		...
		quitButton.addOnClicked(&quitButtonClick);
	}
...
*/
	...
	void runButtonClick(Button button) {
		...
		layout.graph = graph;
		layout.MT = layoutUI.getThreadsEnable;
		layout.nThreads = layoutUI.getThreadsNum;

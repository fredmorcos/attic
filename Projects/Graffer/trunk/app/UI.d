...
public:	
	this() {
		...
		with (quitButton = new Button(StockID.QUIT, false)) {
		}
		...
		with (mainButtonsBox = new HBox(false, 5)) {
			packStart(aboutButton, true, true, 0);
			packStart(quitButton, true, true, 0);
		}
		...
		with (toolBox = new VBox(false, 5)) {
			...
			packStart(mainButtonsBox, false, false, 0);
		}

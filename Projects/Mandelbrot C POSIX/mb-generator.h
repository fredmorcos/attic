...
#ifndef MB_GENERATOR_H
#define MB_GENERATOR_H

void generator_render(double, double, double, double, int, int);
void generator_render_no_locks(double, double, double, double, int, int);

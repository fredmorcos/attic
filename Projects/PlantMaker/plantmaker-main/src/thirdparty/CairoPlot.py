...
class Plot(object):
    ...
    def render_bounding_box(self):
        ...
        self.context.rectangle(self.line_width, self.line_width,
    ...
    def render_vert_labels(self):
        ...
        if not labels:
            ...
            if amplitude % 10:
                ...
                labels = ["%.4lf" % (float(self.bounds[VERT][0] + (amplitude * i / 10.0))) for i in range(10) ]
            else:

...
class Plant(object):
	...
	def fromXml(xmlDoc):
		...
		plant.zincBreakTime = int(element[0].getAttribute("zincBreakTime"))
		plant.craneMoveTime = int(element[0].getAttribute("craneMoveTime"))
		plant.numberOfCranes = int(element[0].getAttribute("numberOfCranes"))

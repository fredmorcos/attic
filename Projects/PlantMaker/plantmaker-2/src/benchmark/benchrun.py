...
from benchmark.simulatorperf import SimulatorLargeValuesPerf, SimulatorMachinesPerf, \
  SimulatorOrdersPerf
from benchmark.optimizerperf import OptimizerIterationsPerf, OptimizerLargeValuesPerf, \
...
from benchmark.evaluatorperf import EvaluatorLargeValuesPerf, EvaluatorMachinesPerf, \
  EvaluatorOrdersPerf

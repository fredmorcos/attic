...
/*******************************************************
 * C file translated from WHIRL Tue Sep 20 06:40:22 2011
 *******************************************************/
...
#line 93 "main.upc"
        add_vectors(_bupc_Mcvtptr6, _bupc_Mcvtptr8, _bupc_Mcvtptr10, (int) 0, (int) 1);
#line 93 "main.upc"
        _27 :;
#line 93 "main.upc"
        i = i + 1;
...
#line 91 "main.upc"
      {
        ...
        _bupc_comma = upcr_hasMyAffinity_pshared(_bupc_Mptra11);
        if(_bupc_comma != 0)
        {
#line 93 "main.upc"
          _bupc_Mptra12 = UPCR_ADD_PSHARED1(veca, 8ULL, i);
#line 93 "main.upc"
          _bupc_Mcvtptr13 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra12);
#line 93 "main.upc"
          _bupc_Mptra14 = UPCR_ADD_PSHARED1(vecb, 8ULL, i);
#line 93 "main.upc"
          _bupc_Mcvtptr15 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra14);
#line 93 "main.upc"
          _bupc_Mptra16 = UPCR_ADD_PSHARED1(vecc, 8ULL, i);
#line 93 "main.upc"
          _bupc_Mcvtptr17 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra16);
#line 93 "main.upc"
          add_vectors(_bupc_Mcvtptr13, _bupc_Mcvtptr15, _bupc_Mcvtptr17, (int) 0, (int) 1);
        }
#line 93 "main.upc"
        _3 :;
#line 93 "main.upc"
...
#line 211 "main.upc"
      _bupc_Mptra19 = UPCR_ADD_PSHARED1(vecc, 8ULL, i);
#line 211 "main.upc"
      _bupc_spillld20 = UPCR_GET_PSHARED_DOUBLEVAL(_bupc_Mptra19, 0);
#line 211 "main.upc"
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--24155-1316526022/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--24155-1316526022/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_translatetime, 
 "$UPCTranslateTime: (main.o) Tue Sep 20 06:40:22 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526022_transver_2,

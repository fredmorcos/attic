...
/*******************************************************
 * C file translated from WHIRL Tue Sep 20 06:57:37 2011
 *******************************************************/
...
#line 62 "main.upc"
      _bupc_Mptra6 = UPCR_ADD_SHARED(veca, 8ULL, i, 2ULL);
#line 62 "main.upc"
      _bupc_Mptra4 = UPCR_ADD_SHARED(vecb, 8ULL, i, 2ULL);
#line 62 "main.upc"
...
#line 183 "main.upc"
      {
#line 184 "main.upc"
        _bupc_Mptra7 = UPCR_ADD_SHARED(veca, 8ULL, i, 2ULL);
#line 184 "main.upc"
        _bupc_call0 = bupc_memget_async(vecblock_a, _bupc_Mptra7, (unsigned long) 16ULL);
#line 184 "main.upc"
        handle_a = _bupc_call0;
#line 185 "main.upc"
        _bupc_Mptra8 = UPCR_ADD_SHARED(vecb, 8ULL, i, 2ULL);
#line 185 "main.upc"
        _bupc_call1 = bupc_memget_async(vecblock_b, _bupc_Mptra8, (unsigned long) 16ULL);
#line 185 "main.upc"
...
#line 192 "main.upc"
        upc_memput(_bupc_Mptra9, vecblock_c, (unsigned long) 16ULL);
#line 193 "main.upc"
        _3 :;
#line 193 "main.upc"
        i = i + 2;
...
#line 211 "main.upc"
      _bupc_Mptra11 = UPCR_ADD_SHARED(vecc, 8ULL, i, 2ULL);
#line 211 "main.upc"
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--29318-1316527057/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--29318-1316527057/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_translatetime, 
 "$UPCTranslateTime: (main.o) Tue Sep 20 06:57:37 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1316527057_transver_2,

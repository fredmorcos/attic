...
/*******************************************************
 * C file translated from WHIRL Tue Sep 20 06:41:10 2011
 *******************************************************/
...
#line 51 "main.upc"
  ...
  _IEEE64 * _bupc_Mcvtptr13;
  upcr_shared_ptr_t _bupc_Mptra14;
  _IEEE64 * _bupc_Mcvtptr15;
  upcr_shared_ptr_t _bupc_Mptra16;
  _IEEE64 * _bupc_Mcvtptr17;
  upcr_pshared_ptr_t _bupc_Mptra18;
  upcr_shared_ptr_t _bupc_Mptra19;
  _IEEE64 _bupc_spillld20;
  upcr_pshared_ptr_t _bupc_Mptra21;
  _IEEE64 _bupc_spillld22;
...
#line 61 "main.upc"
    {
#line 62 "main.upc"
      _bupc_Mptra0 = UPCR_ADD_SHARED(vecb, 8ULL, i, 250000ULL);
      _bupc_spillstoreparm1 = (_IEEE64)(i);
#line 62 "main.upc"
      UPCR_PUT_SHARED(_bupc_Mptra0, 0, &_bupc_spillstoreparm1, 8);
#line 62 "main.upc"
      _bupc_Mptra4 = UPCR_ADD_SHARED(veca, 8ULL, i, 250000ULL);
#line 62 "main.upc"
...
#line 91 "main.upc"
      ...
      {
#line 93 "main.upc"
        _bupc_Mptra5 = UPCR_ADD_SHARED(veca, 8ULL, i, 250000ULL);
#line 93 "main.upc"
        _bupc_Mcvtptr6 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra5);
#line 93 "main.upc"
        _bupc_Mptra7 = UPCR_ADD_SHARED(vecb, 8ULL, i, 250000ULL);
#line 93 "main.upc"
...
#line 93 "main.upc"
        add_vectors(_bupc_Mcvtptr6, _bupc_Mcvtptr8, _bupc_Mcvtptr10, (int) 0, (int) 250000);
#line 93 "main.upc"
        _27 :;
#line 93 "main.upc"
        i = i + 250000;
...
#line 91 "main.upc"
      {
        _bupc_Mptra11 = UPCR_ADD_SHARED(veca, 8ULL, i, 250000ULL);
        _bupc_comma = upcr_hasMyAffinity_shared(_bupc_Mptra11);
        if(_bupc_comma != 0)
        {
#line 93 "main.upc"
          _bupc_Mptra12 = UPCR_ADD_SHARED(veca, 8ULL, i, 250000ULL);
#line 93 "main.upc"
          _bupc_Mcvtptr13 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra12);
#line 93 "main.upc"
          _bupc_Mptra14 = UPCR_ADD_SHARED(vecb, 8ULL, i, 250000ULL);
#line 93 "main.upc"
          _bupc_Mcvtptr15 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra14);
#line 93 "main.upc"
          _bupc_Mptra16 = UPCR_ADD_SHARED(vecc, 8ULL, i, 250000ULL);
#line 93 "main.upc"
          _bupc_Mcvtptr17 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra16);
#line 93 "main.upc"
          add_vectors(_bupc_Mcvtptr13, _bupc_Mcvtptr15, _bupc_Mcvtptr17, (int) 0, (int) 250000);
        }
#line 93 "main.upc"
        _3 :;
#line 93 "main.upc"
...
#line 200 "main.upc"
    _bupc_Mptra18 = UPCR_ADD_PSHARED1(time_diffs, 8ULL, ((int) upcr_mythread () ));
    UPCR_PUT_PSHARED_DOUBLEVAL(_bupc_Mptra18, 0, _bupc_comma0);
#line 201 "main.upc"
...
#line 211 "main.upc"
      _bupc_Mptra19 = UPCR_ADD_SHARED(vecc, 8ULL, i, 250000ULL);
#line 211 "main.upc"
      _bupc_spillld20 = UPCR_GET_SHARED_DOUBLEVAL(_bupc_Mptra19, 0);
#line 211 "main.upc"
      if(_bupc_spillld20 != (_bupc___save_expr0 + _bupc___save_expr0))
#line 211 "main.upc"
      {
#line 212 "main.upc"
        printf("error\n");
...
#line 221 "main.upc"
    {
#line 222 "main.upc"
      _bupc_Mptra21 = UPCR_ADD_PSHARED1(time_diffs, 8ULL, thread);
#line 222 "main.upc"
      _bupc_spillld22 = UPCR_GET_PSHARED_DOUBLEVAL(_bupc_Mptra21, 0);
#line 222 "main.upc"
      printf("T %2d: %.15f s\n", thread, _bupc_spillld22);
#line 222 "main.upc"
      _6 :;
#line 222 "main.upc"
      thread = thread + 1;
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--24628-1316526070/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--24628-1316526070/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_translatetime, 
 "$UPCTranslateTime: (main.o) Tue Sep 20 06:41:10 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526070_transver_2,

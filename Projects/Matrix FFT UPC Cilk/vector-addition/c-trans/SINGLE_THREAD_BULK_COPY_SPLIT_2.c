...
/*******************************************************
 * C file translated from WHIRL Tue Sep 20 06:54:42 2011
 *******************************************************/
...
#line 51 "main.upc"
  ...
  _IEEE64 vecblock_a[2LL];
  _IEEE64 vecblock_b[2LL];
  _IEEE64 vecblock_c[2LL];
  struct timespec end;
...
#line 150 "main.upc"
        upc_memget(vecblock_a, _bupc_Mptra5, (unsigned long) 16ULL);
#line 151 "main.upc"
        _bupc_Mptra6 = UPCR_ADD_SHARED(vecb, 8ULL, i, 2ULL);
#line 151 "main.upc"
        upc_memget(vecblock_b, _bupc_Mptra6, (unsigned long) 16ULL);
#line 153 "main.upc"
        add_vectors(vecblock_a, vecblock_b, vecblock_c, (int) 0, (int) 2);
#line 155 "main.upc"
        _bupc_Mptra7 = UPCR_ADD_SHARED(vecc, 8ULL, i, 2ULL);
#line 155 "main.upc"
        upc_memput(_bupc_Mptra7, vecblock_c, (unsigned long) 16ULL);
#line 156 "main.upc"
        _3 :;
#line 156 "main.upc"
        i = i + 2;
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--28575-1316526882/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--28575-1316526882/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_translatetime, 
 "$UPCTranslateTime: (main.o) Tue Sep 20 06:54:42 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1316526882_transver_2,

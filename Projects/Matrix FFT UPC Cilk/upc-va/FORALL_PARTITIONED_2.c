...
/*******************************************************
 * C file translated from WHIRL Thu Feb  9 07:19:10 2012
 *******************************************************/
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--19486-1328800750/main.trans.c) RELEASE=1.18.0,SPEC=1.8,CONDUIT=IBV(IBV-1.14/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--19486-1328800750/main.trans.c) VERSION=2.14.0,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_translatetime, 
 "$UPCTranslateTime: (main.o) Thu Feb  9 07:19:10 2012 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.14.0/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_upcver, 
 "$UPCVersion: (main.o) 2.14.0 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800750_transver_2,

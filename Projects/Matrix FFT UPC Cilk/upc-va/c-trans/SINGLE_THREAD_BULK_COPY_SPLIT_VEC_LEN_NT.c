...
/*******************************************************
 * C file translated from WHIRL Thu Sep 29 06:14:19 2011
 *******************************************************/
...
#line 143 "main.upc"
        upc_memget(vecblock_a, _bupc_Mptra5, (unsigned long) 2000000ULL);
#line 144 "main.upc"
        _bupc_Mptra6 = UPCR_ADD_SHARED(vecb, 8ULL, i, 250000ULL);
#line 144 "main.upc"
        upc_memget(vecblock_b, _bupc_Mptra6, (unsigned long) 2000000ULL);
#line 146 "main.upc"
        addvecs(vecblock_a, vecblock_b, vecblock_c, (int) 0, (int) 250000);
#line 148 "main.upc"
        _bupc_Mptra7 = UPCR_ADD_SHARED(vecc, 8ULL, i, 250000ULL);
#line 148 "main.upc"
        upc_memput(_bupc_Mptra7, vecblock_c, (unsigned long) 2000000ULL);
#line 149 "main.upc"
        _3 :;
#line 149 "main.upc"
        i = i + 250000;
...
#line 193 "main.upc"
    _bupc_Mptra8 = UPCR_ADD_PSHARED1(time_diffs, 8ULL, ((int) upcr_mythread () ));
    UPCR_PUT_PSHARED_DOUBLEVAL(_bupc_Mptra8, 0, _bupc_comma);
#line 194 "main.upc"
...
#line 204 "main.upc"
      _bupc_spillld10 = UPCR_GET_SHARED_DOUBLEVAL(_bupc_Mptra9, 0);
#line 204 "main.upc"
      if(_bupc_spillld10 != (_bupc___save_expr0 + _bupc___save_expr0))
#line 204 "main.upc"
      {
#line 205 "main.upc"
        printf("error\n");
...
#line 214 "main.upc"
    {
#line 215 "main.upc"
      _bupc_Mptra11 = UPCR_ADD_PSHARED1(time_diffs, 8ULL, thread);
#line 215 "main.upc"
      _bupc_spillld12 = UPCR_GET_PSHARED_DOUBLEVAL(_bupc_Mptra11, 0);
#line 215 "main.upc"
      printf("T %2d: %.15f s\n", thread, _bupc_spillld12);
#line 215 "main.upc"
      _6 :;
#line 215 "main.upc"
      thread = thread + 1;
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--30944-1317302059/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--30944-1317302059/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_translatetime, 
 "$UPCTranslateTime: (main.o) Thu Sep 29 06:14:19 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1317302059_transver_2,

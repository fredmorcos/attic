...
/*******************************************************
 * C file translated from WHIRL Thu Sep 29 06:00:06 2011
 *******************************************************/
...
#line 90 "main.upc"
        addvecs(_bupc_Mcvtptr6, _bupc_Mcvtptr8, _bupc_Mcvtptr10, (int) 0, (int) 2);
#line 90 "main.upc"
        _27 :;
#line 90 "main.upc"
        i = i + 2;
...
#line 89 "main.upc"
      {
        ...
        {
#line 90 "main.upc"
          _bupc_Mptra12 = UPCR_ADD_SHARED(veca, 8ULL, i, 2ULL);
#line 90 "main.upc"
          _bupc_Mcvtptr13 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra12);
#line 90 "main.upc"
          _bupc_Mptra14 = UPCR_ADD_SHARED(vecb, 8ULL, i, 2ULL);
#line 90 "main.upc"
          _bupc_Mcvtptr15 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra14);
#line 90 "main.upc"
          _bupc_Mptra16 = UPCR_ADD_SHARED(vecc, 8ULL, i, 2ULL);
#line 90 "main.upc"
          _bupc_Mcvtptr17 = (_IEEE64 *) UPCR_SHARED_TO_LOCAL(_bupc_Mptra16);
#line 90 "main.upc"
          addvecs(_bupc_Mcvtptr13, _bupc_Mcvtptr15, _bupc_Mcvtptr17, (int) 0, (int) 2);
        }
#line 90 "main.upc"
        _3 :;
#line 90 "main.upc"
...
#line 204 "main.upc"
      _bupc_Mptra19 = UPCR_ADD_SHARED(vecc, 8ULL, i, 2ULL);
#line 204 "main.upc"
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--24777-1317301206/main.trans.c) RELEASE=1.16.2,SPEC=1.8,CONDUIT=IBV(IBV-1.13/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--24777-1317301206/main.trans.c) VERSION=2.12.2,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_translatetime, 
 "$UPCTranslateTime: (main.o) Thu Sep 29 06:00:06 2011 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.12.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_upcver, 
 "$UPCVersion: (main.o) 2.12.2 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1317301206_transver_2,

...
/*******************************************************
 * C file translated from WHIRL Thu Feb  9 07:19:57 2012
 *******************************************************/

/* UPC Runtime specification expected: 3.6 */
#define UPCR_WANT_MAJOR 3
#define UPCR_WANT_MINOR 6
/* UPC translator version: release 2.14.0, built on Oct 25 2011 at 16:40:27, host aphid linux-x86_64/64, gcc v4.2.4 (Ubuntu 4.2.4-1ubuntu4) */
...
#include</home/ica/k339970/opt/opt/include/upcr_preinclude/upc_bits.h>
...
#line 103 "main.upc"
        _bupc_Mcvtptr6 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra5);
#line 103 "main.upc"
        _bupc_Mptra7 = UPCR_ADD_PSHARED1(vecb, 8ULL, i);
#line 103 "main.upc"
        _bupc_Mcvtptr8 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra7);
#line 103 "main.upc"
        _bupc_Mptra9 = UPCR_ADD_PSHARED1(vecc, 8ULL, i);
#line 103 "main.upc"
        _bupc_Mcvtptr10 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra9);
#line 103 "main.upc"
        addvecs(_bupc_Mcvtptr6, _bupc_Mcvtptr8, _bupc_Mcvtptr10, (int) 0, (int) 1);
#line 103 "main.upc"
        _27 :;
#line 103 "main.upc"
        i = i + 1;
...
#line 102 "main.upc"
      {
        ...
        if(_I4MOD(i, _bupc_Tthreads0) == _bupc_comma)
        {
#line 103 "main.upc"
          _bupc_Mptra11 = UPCR_ADD_PSHARED1(veca, 8ULL, i);
#line 103 "main.upc"
          _bupc_Mcvtptr12 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra11);
#line 103 "main.upc"
          _bupc_Mptra13 = UPCR_ADD_PSHARED1(vecb, 8ULL, i);
#line 103 "main.upc"
          _bupc_Mcvtptr14 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra13);
#line 103 "main.upc"
          _bupc_Mptra15 = UPCR_ADD_PSHARED1(vecc, 8ULL, i);
#line 103 "main.upc"
          _bupc_Mcvtptr16 = (_IEEE64 *) UPCR_PSHARED_TO_LOCAL(_bupc_Mptra15);
#line 103 "main.upc"
          addvecs(_bupc_Mcvtptr12, _bupc_Mcvtptr14, _bupc_Mcvtptr16, (int) 0, (int) 1);
        }
#line 103 "main.upc"
        _3 :;
#line 103 "main.upc"
...
#line 205 "main.upc"
      _bupc_Mptra18 = UPCR_ADD_PSHARED1(vecc, 8ULL, i);
#line 205 "main.upc"
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--19732-1328800797/main.trans.c) RELEASE=1.18.0,SPEC=1.8,CONDUIT=IBV(IBV-1.14/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--19732-1328800797/main.trans.c) VERSION=2.14.0,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_translatetime, 
 "$UPCTranslateTime: (main.o) Thu Feb  9 07:19:58 2012 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.14.0/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_upcver, 
 "$UPCVersion: (main.o) 2.14.0 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_compileline, 
 "$UPCCompileLine: (main.o) /usr/local/upc/2.14.0/runtime/inst/bin/upcc.pl --at-remote-http --arch-size=64 --network=ibv -T 4 --lines --trans --sizes-file=upcc-sizes main.i $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800798_transver_2,
 "$UPCTranslatorVersion: (main.o) 2.14.0, built on Oct 25 2011 at 16:40:27, host aphid linux-x86_64/64, gcc v4.2.4 (Ubuntu 4.2.4-1ubuntu4) $");

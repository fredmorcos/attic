...
/*******************************************************
 * C file translated from WHIRL Thu Feb  9 07:19:34 2012
 *******************************************************/
...
#line 49 "main.upc"
  ...
  _IEEE64 _bupc_spillstoreparm16;
...
#line 99 "main.upc"
      {
        ...
        if(_I4MOD(i / 250000, _bupc_Tthreads0) == _bupc_comma)
        {
#line 100 "main.upc"
          _bupc_Mptra15 = UPCR_ADD_SHARED(vecc, 8ULL, i, 250000ULL);
#line 100 "main.upc"
          _bupc_Mptra11 = UPCR_ADD_SHARED(veca, 8ULL, i, 250000ULL);
#line 100 "main.upc"
          _bupc_spillld12 = UPCR_GET_SHARED_DOUBLEVAL(_bupc_Mptra11, 0);
#line 100 "main.upc"
          _bupc_Mptra13 = UPCR_ADD_SHARED(vecb, 8ULL, i, 250000ULL);
#line 100 "main.upc"
          _bupc_spillld14 = UPCR_GET_SHARED_DOUBLEVAL(_bupc_Mptra13, 0);
          _bupc_spillstoreparm16 = _bupc_spillld12 + _bupc_spillld14;
#line 100 "main.upc"
          UPCR_PUT_SHARED(_bupc_Mptra15, 0, &_bupc_spillstoreparm16, 8);
        }
#line 100 "main.upc"
        _3 :;
#line 100 "main.upc"
...
#line 205 "main.upc"
      _bupc_Mptra18 = UPCR_ADD_SHARED(vecc, 8ULL, i, 250000ULL);
#line 205 "main.upc"
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--19609-1328800774/main.trans.c) RELEASE=1.18.0,SPEC=1.8,CONDUIT=IBV(IBV-1.14/IBV-1.12),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,nopshm,nodebug,notrace,nostats,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--19609-1328800774/main.trans.c) VERSION=2.14.0,PLATFORMENV=distributed,SHMEM=none,SHAREDPTRREP=packed/p21:t8:a35,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=4 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_translatetime, 
 "$UPCTranslateTime: (main.o) Thu Feb  9 07:19:34 2012 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_GASNetConfig_obj, 
 "$GASNetConfig: (main.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_UPCRConfig_obj,
 "$UPCRConfig: (main.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_translator, 
 "$UPCTranslator: (main.o) /usr/local/upc/2.14.0/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_upcver, 
 "$UPCVersion: (main.o) 2.14.0 $");
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_compileline, 
...
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_backendcompiler, 
 "$UPCRBackendCompiler: (main.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_configuremismatch, 
   "$UPCRConfigureMismatch: (main.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_configuredcompiler, 
   "$UPCRConfigureCompiler: (main.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_buildcompiler, 
   "$UPCRBuildCompiler: (main.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_main_o_1328800774_transver_2,

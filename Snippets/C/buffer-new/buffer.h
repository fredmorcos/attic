...
int buffer_deinit(struct buffer *buffer,
                  DtorFunc *destructor);

void *buffer_get(struct buffer *buffer, size_t index);
void  buffer_set(struct buffer *buffer, size_t index, void *element);

bool buffer_put(struct buffer *buffer, size_t index, void *element);
bool buffer_rem(struct buffer *buffer, size_t index, DtorFunc *destructor);
